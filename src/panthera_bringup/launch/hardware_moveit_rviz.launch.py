...
def generate_launch_description():
    ...
    panthera_config_share = get_package_share_directory("panthera_moveit_config")
    panthera_bringup_share = get_package_share_directory("panthera_bringup")
    ...
    moveit_config = (
        MoveItConfigsBuilder(
            ...
            package_name="panthera_moveit_config",
        )
