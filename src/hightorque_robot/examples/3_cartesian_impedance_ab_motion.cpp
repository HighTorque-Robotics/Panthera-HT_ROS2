/**
 * @file 3_cartesian_impedance_ab_motion.cpp
...
int main(int argc, char** argv)
{
    try {
        ...
        // 创建机械臂对象
        std::string config_path = ament_index_cpp::get_package_share_path("hightorque_robot").string() + "/robot_param/Follower.yaml";
        if (argc > 1) {
            config_path = argv[1];
        }
