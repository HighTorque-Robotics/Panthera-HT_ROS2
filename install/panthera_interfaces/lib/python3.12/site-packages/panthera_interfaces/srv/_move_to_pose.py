...
class Metaclass_MoveToPose_Request(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'CARTESIAN_PATH__DEFAULT': False,
            'VELOCITY_SCALING__DEFAULT': 1.0,
            'ACCELERATION_SCALING__DEFAULT': 1.0,
        }

    @property
    def CARTESIAN_PATH__DEFAULT(cls):
        """Return default value for message field 'cartesian_path'."""
        return False
...
class MoveToPose_Request(metaclass=Metaclass_MoveToPose_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.cartesian_path = kwargs.get(
            'cartesian_path', MoveToPose_Request.CARTESIAN_PATH__DEFAULT)
        self.velocity_scaling = kwargs.get(
            'velocity_scaling', MoveToPose_Request.VELOCITY_SCALING__DEFAULT)
        self.acceleration_scaling = kwargs.get(
            'acceleration_scaling', MoveToPose_Request.ACCELERATION_SCALING__DEFAULT)
...
class Metaclass_MoveToPose_Event(type):
    """Metaclass of message 'MoveToPose_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_to_pose__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_to_pose__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_to_pose__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_to_pose__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_to_pose__event
...
class MoveToPose_Event(metaclass=Metaclass_MoveToPose_Event):
    """Message class 'MoveToPose_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<panthera_interfaces/MoveToPose_Request, 1>',
        'response': 'sequence<panthera_interfaces/MoveToPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['panthera_interfaces', 'srv'], 'MoveToPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['panthera_interfaces', 'srv'], 'MoveToPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from panthera_interfaces.srv import MoveToPose_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, MoveToPose_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MoveToPose_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from panthera_interfaces.srv import MoveToPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MoveToPose_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MoveToPose_Response'"
...
class Metaclass_MoveToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'panthera_interfaces.srv.MoveToPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from panthera_interfaces.srv import _move_to_pose
            ...
            if _move_to_pose.Metaclass_MoveToPose_Event._TYPE_SUPPORT is None:
                _move_to_pose.Metaclass_MoveToPose_Event.__import_type_support__()


class MoveToPose(metaclass=Metaclass_MoveToPose):
    from panthera_interfaces.srv._move_to_pose import MoveToPose_Request as Request
    from panthera_interfaces.srv._move_to_pose import MoveToPose_Response as Response
    from panthera_interfaces.srv._move_to_pose import MoveToPose_Event as Event
