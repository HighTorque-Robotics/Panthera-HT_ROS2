...
#ifndef PANTHERA_INTERFACES__SRV__DETAIL__GRIPPER_SRV__FUNCTIONS_H_
#define PANTHERA_INTERFACES__SRV__DETAIL__GRIPPER_SRV__FUNCTIONS_H_
...
/// Initialize srv/GripperSrv message.
/**
 ...
 * )) before or use
 * panthera_interfaces__srv__GripperSrv_Request__create()
...
/// Finalize srv/GripperSrv message.
/**
...
/// Create srv/GripperSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * panthera_interfaces__srv__GripperSrv_Request__init().
...
/// Destroy srv/GripperSrv message.
/**
 * It calls
 * panthera_interfaces__srv__GripperSrv_Request__fini()
...
/// Check for srv/GripperSrv message equality.
/**
...
/// Initialize array of srv/GripperSrv messages.
/**
...
/// Finalize array of srv/GripperSrv messages.
/**
 * It calls
 * panthera_interfaces__srv__GripperSrv_Request__fini()
...
/// Create array of srv/GripperSrv messages.
/**
 * It allocates the memory for the array and calls
 * panthera_interfaces__srv__GripperSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GripperSrv messages.
/**
 * It calls
 * panthera_interfaces__srv__GripperSrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GripperSrv message array equality.
/**
...
/// Copy an array of srv/GripperSrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * panthera_interfaces__srv__GripperSrv_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_panthera_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * panthera_interfaces__srv__GripperSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_panthera_interfaces
...
/**
 * It calls
 * panthera_interfaces__srv__GripperSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_panthera_interfaces
...
/**
 * It allocates the memory for the array and calls
 * panthera_interfaces__srv__GripperSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_panthera_interfaces
...
/**
 * It calls
 * panthera_interfaces__srv__GripperSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * panthera_interfaces__srv__GripperSrv_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_panthera_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * panthera_interfaces__srv__GripperSrv_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_panthera_interfaces
...
/**
 * It calls
 * panthera_interfaces__srv__GripperSrv_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_panthera_interfaces
...
/**
 * It allocates the memory for the array and calls
 * panthera_interfaces__srv__GripperSrv_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_panthera_interfaces
...
/**
 * It calls
 * panthera_interfaces__srv__GripperSrv_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PANTHERA_INTERFACES__SRV__DETAIL__GRIPPER_SRV__FUNCTIONS_H_
