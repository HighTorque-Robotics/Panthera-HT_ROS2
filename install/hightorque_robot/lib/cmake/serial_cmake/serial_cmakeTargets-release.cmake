...
set_target_properties(serial::serial_cmake PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libserial_cmake.so"
  IMPORTED_SONAME_RELEASE "libserial_cmake.so"
  )

list(APPEND _cmake_import_check_targets serial::serial_cmake )
list(APPEND _cmake_import_check_files_for_serial::serial_cmake "${_IMPORT_PREFIX}/lib/libserial_cmake.so" )
