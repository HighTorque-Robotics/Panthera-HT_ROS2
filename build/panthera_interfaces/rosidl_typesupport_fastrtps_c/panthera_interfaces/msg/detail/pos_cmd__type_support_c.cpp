...
#include "panthera_interfaces/msg/detail/pos_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _PosCmd__ros_msg_type = panthera_interfaces__msg__PosCmd;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = panthera_interfaces__msg__PosCmd;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const panthera_interfaces__msg__PosCmd * ros_message = static_cast<const panthera_interfaces__msg__PosCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_panthera_interfaces__msg__PosCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  panthera_interfaces__msg__PosCmd * ros_message = static_cast<panthera_interfaces__msg__PosCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_panthera_interfaces__msg__PosCmd(cdr, ros_message);
}

static uint32_t _PosCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_panthera_interfaces__msg__PosCmd(
...
static size_t _PosCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_panthera_interfaces__msg__PosCmd(
