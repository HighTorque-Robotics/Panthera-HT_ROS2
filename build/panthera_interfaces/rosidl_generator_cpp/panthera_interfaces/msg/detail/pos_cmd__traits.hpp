...
#ifndef PANTHERA_INTERFACES__MSG__DETAIL__POS_CMD__TRAITS_HPP_
#define PANTHERA_INTERFACES__MSG__DETAIL__POS_CMD__TRAITS_HPP_
...
inline void to_yaml(
  const panthera_interfaces::msg::PosCmd & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const panthera_interfaces::msg::PosCmd & msg)
{
  return panthera_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<panthera_interfaces::msg::PosCmd>()
{
  return "panthera_interfaces::msg::PosCmd";
}

template<>
inline const char * name<panthera_interfaces::msg::PosCmd>()
{
  return "panthera_interfaces/msg/PosCmd";
}

template<>
struct has_fixed_size<panthera_interfaces::msg::PosCmd>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<panthera_interfaces::msg::PosCmd>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<panthera_interfaces::msg::PosCmd>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PANTHERA_INTERFACES__MSG__DETAIL__POS_CMD__TRAITS_HPP_
