...
#include "panthera_interfaces/msg/detail/pos_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const panthera_interfaces::msg::PosCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  panthera_interfaces::msg::PosCmd & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = panthera_interfaces::msg::PosCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const panthera_interfaces::msg::PosCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<panthera_interfaces::msg::PosCmd *>(
    untyped_ros_message);
...
{
  return &panthera_interfaces::msg::typesupport_fastrtps_cpp::_PosCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, panthera_interfaces, msg, PosCmd)() {
  return &panthera_interfaces::msg::typesupport_fastrtps_cpp::_PosCmd__handle;
}
