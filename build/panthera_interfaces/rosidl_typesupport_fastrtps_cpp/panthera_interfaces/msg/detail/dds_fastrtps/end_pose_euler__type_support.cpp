...
#include "panthera_interfaces/msg/detail/end_pose_euler__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = panthera_interfaces::msg::EndPoseEuler;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const panthera_interfaces::msg::EndPoseEuler *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<panthera_interfaces::msg::EndPoseEuler *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EndPoseEuler__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const panthera_interfaces::msg::EndPoseEuler *>(
...
static size_t _EndPoseEuler__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EndPoseEuler(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EndPoseEuler__callbacks = {
...
static rosidl_message_type_support_t _EndPoseEuler__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EndPoseEuler__callbacks,
...
{
  return &panthera_interfaces::msg::typesupport_fastrtps_cpp::_EndPoseEuler__handle;
}
