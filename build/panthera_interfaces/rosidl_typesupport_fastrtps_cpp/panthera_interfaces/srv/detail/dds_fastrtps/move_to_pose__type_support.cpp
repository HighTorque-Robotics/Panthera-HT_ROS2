...
#include "panthera_interfaces/srv/detail/move_to_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const panthera_interfaces::srv::MoveToPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  panthera_interfaces::srv::MoveToPose_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = panthera_interfaces::srv::MoveToPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const panthera_interfaces::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<panthera_interfaces::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
{
  return &panthera_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, panthera_interfaces, srv, MoveToPose_Request)() {
  return &panthera_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_panthera_interfaces
cdr_serialize(
  const panthera_interfaces::srv::MoveToPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  panthera_interfaces::srv::MoveToPose_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = panthera_interfaces::srv::MoveToPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const panthera_interfaces::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<panthera_interfaces::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &panthera_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, panthera_interfaces, srv, MoveToPose_Response)() {
  return &panthera_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
// functions for panthera_interfaces::srv::MoveToPose_Request already declared above

// functions for panthera_interfaces::srv::MoveToPose_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_panthera_interfaces
cdr_serialize(
  const panthera_interfaces::srv::MoveToPose_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  panthera_interfaces::srv::MoveToPose_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        panthera_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_MoveToPose_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        panthera_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_MoveToPose_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = panthera_interfaces::srv::MoveToPose_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        panthera_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_MoveToPose_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        panthera_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_MoveToPose_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const panthera_interfaces::srv::MoveToPose_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<panthera_interfaces::srv::MoveToPose_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &panthera_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, panthera_interfaces, srv, MoveToPose_Event)() {
  return &panthera_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Event__handle;
}
...
static const rosidl_service_type_support_t _MoveToPose__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<panthera_interfaces::srv::MoveToPose_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<panthera_interfaces::srv::MoveToPose_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<panthera_interfaces::srv::MoveToPose_Event>(),
...
{
  return &panthera_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, panthera_interfaces, srv, MoveToPose)() {
  return &panthera_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
