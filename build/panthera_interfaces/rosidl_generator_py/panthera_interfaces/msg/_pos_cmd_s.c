...
bool panthera_interfaces__msg__pos_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("panthera_interfaces.msg._pos_cmd.PosCmd", full_classname_dest, 39) == 0);
  }
  panthera_interfaces__msg__PosCmd * ros_message = _ros_message;
  {  // x
  ...
  {  // mode1
    ...
    ros_message->mode1 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // mode2
    ...
    assert(PyLong_Check(field));
    ros_message->mode2 = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * panthera_interfaces__msg__pos_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("panthera_interfaces.msg._pos_cmd");
  ...
  {  // mode1
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->mode1);
    {
  ...
  {  // mode2
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->mode2);
    {
